...
import com.EvgenWarGold.SpaceCraft.Api.Perlin.NoiseModule;
import com.EvgenWarGold.SpaceCraft.Api.World.BiomeGenSpaceSC;
import com.EvgenWarGold.SpaceCraft.Api.World.EnumCraterSize;
import com.EvgenWarGold.SpaceCraft.Api.World.MapGenBaseMeta;

public class ChunkProviderMoon extends ChunkProviderGenerate {

    final Block topBlockID = Blocks.packed_ice;
    final byte topBlockMeta = 0;
    final Block fillBlockID = Blocks.ice;
    ...
    public BiomeDecoratorMoon biomedecoratorplanet = new BiomeDecoratorMoon(BiomeGenSpaceSC.SPACE);

    private final World worldObj;

    private BiomeGenBase[] biomesForGeneration = { BiomeGenSpaceSC.SPACE };
    ...
    public List<BiomeGenBase.SpawnListEntry> getPossibleCreatures(EnumCreatureType par1EnumCreatureType, int i, int j,
        ...
        if (par1EnumCreatureType == EnumCreatureType.monster) {
            return BiomeGenSpaceSC.SPACE.getSpawnableList(par1EnumCreatureType);
        }
        return null;
    }
}
